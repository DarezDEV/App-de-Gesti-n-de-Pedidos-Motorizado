...
# Rutas del dashboard
app.add_url_rule('/dashboard/admin', view_func=dashboard_service.admin_dashboard)
app.add_url_rule('/dashboard/cliente', view_func=dashboard_service.cliente_dashboard)
app.add_url_rule('/dashboard/motorizado', view_func=dashboard_service.motorizado_dashboard)

app.add_url_rule('/motorizado/pedidos', view_func=dashboard_service.motorizado_pedidos)
app.add_url_rule('/marcar_entregado/<int:order_id>', view_func=dashboard_service.marcar_entregado, methods=['POST'])
...
app.add_url_rule('/delete_user/<int:user_id>', view_func=admin_controller.delete_user, methods=['POST'])
app.add_url_rule('/add_user', view_func=admin_controller.create_user, methods=['POST'])

# Rutas de gestión de categoría y productos
...
# Rutas del carrito
app.add_url_rule('/carrito', view_func=dashboard_service.cart_client)
...
app.add_url_rule('/producto/<int:product_id>', view_func=dashboard_service.product_detail)
app.add_url_rule('/track-view', view_func=cart_controller.track_view, methods=['POST'])

# Nuevas rutas para gestión de pedidos
app.add_url_rule('/cliente/orders', view_func=DashboardService.client_orders)
